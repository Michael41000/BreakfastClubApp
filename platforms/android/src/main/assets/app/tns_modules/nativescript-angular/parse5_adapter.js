...
var Parse5DomAdapter = (function (_super) {
    ...
    Parse5DomAdapter.prototype.querySelectorAll = function (el, selector) {
        ...
        var matcher = new private_import_compiler_1.SelectorMatcher();
        matcher.addSelectables(private_import_compiler_1.CssSelector.parse(selector));
    ...
    Parse5DomAdapter.prototype.elementMatches = function (node, selector, matcher) {
        ...
        if (selector && selector.charAt(0) == '#') {
            ...
            if (!matcher) {
                matcher = new private_import_compiler_1.SelectorMatcher();
                matcher.addSelectables(private_import_compiler_1.CssSelector.parse(selector));
            }
            var cssSelector = new private_import_compiler_1.CssSelector();
