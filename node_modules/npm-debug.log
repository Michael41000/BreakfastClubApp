...
4 verbose stack Error: missing script: postinstall
...
5 verbose cwd /Users/michaelrollberg/Documents/BreakfastClub/BreakfastClubApp/node_modules
6 error Darwin 13.3.0
7 error argv "/usr/local/bin/node" "/usr/local/bin/npm" "run" "postinstall"
8 error node v4.5.0
9 error npm  v2.15.9
10 error missing script: postinstall
